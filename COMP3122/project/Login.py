...
# Streamlit app
st.title("GitHub Classroom Project Management")
...
if st.session_state.logged_in:
    ...
    if st.session_state.role == "teacher":
        ...
        st.switch_page("pages/User_Profiles.py")  # Switch to teacher's page
        time.sleep(1)
    elif st.session_state.role == "student":
        st.write("You have access to student resources.")
        # Switch based on permission
        if st.session_state.permission == "leader":
            st.switch_page("pages/User_Profiles.py")  # Switch to student's page
        elif st.session_state.permission == "member":
            st.switch_page("pages/User_Profiles.py")
        else:
